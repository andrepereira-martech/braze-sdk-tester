...
function generateConfig(envVars) {
    const apiKey = envVars.BRAZE_API_KEY || 'your-braze-api-key-here';
    const endpoint = envVars.BRAZE_SDK_ENDPOINT || 'https://sdk.iad-03.braze.com';

    const configContent = `// Braze Configuration
...
export const BRAZE_API_KEY = '${apiKey.replace(/'/g, "\\'")}';
export const BRAZE_SDK_ENDPOINT = '${endpoint.replace(/'/g, "\\'")}';
`;
